...
**Allowing users to purchases bonds thorugh Minting allows Wonderland to accumulate its own liquidity.** We call our own liquidity [**POL**](https://wonderland.gitbook.io/wonderland/references/glossary#pol). More POL ensures there is always locked exit liquidity in our trading pools to facilitate market operations and protect token holders. Since Wonderland becomes its own market, on top of additional certainty for **TIME** investors, the protocol accrues more and more revenue from LP rewards bolstering our treasury.

### &#x20;<a href="#why-is-it-minting-and-not-bonding" id="why-is-it-minting-and-not-bonding"></a>

Here at Wonderland we believe that minting better describes the action that users are taking, when purchasing TIME with different assets. If you go to the "Mint" page of the website, you will be able to mint TIME tokens, effectively selling your assets for discounted **TIME** tokens. Depsite the name difference, a Minting Action is exactly the same as a Bond Purchase on Olympus DAO! You can find the mintings options for Wonderland in the [**Mint**](https://app.wonderland.money/#/mints) **** Page!
